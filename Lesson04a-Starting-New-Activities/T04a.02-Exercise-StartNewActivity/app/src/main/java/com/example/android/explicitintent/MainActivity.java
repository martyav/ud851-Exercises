    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (1) COMPLETED Store ChildActivity.class in a Class object called destinationActivity

                Class destinationActivity = ChildActivity.class;

                // TODO (2) COMPLETED Create an Intent to start ChildActivity

                Intent intent = new Intent(context, destinationActivity);

                // TODO (3) COMPLETED Replace the Toast with code to start ChildActivity

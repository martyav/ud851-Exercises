...
// TODO (1) COMPLETED Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// TODO (2) COMPLETED Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// TODO (3) COMPLETED Give your TextView an ID of tv_display
// TODO (4) COMPLETED Set the text to something that indicates this is default text being displayed
// TODO (5) COMPLETED Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// TODO (6) COMPLETED Create a TextView field to display your message
// TODO (7) COMPLETED Get a reference to your TextView in Java